...
for bias_gp in [0]:
    ...
    row['data_path'] = S.run_iv(bias_groups = [bias_gp], wait_time=0.01, bias_high=18, bias_low=0, bias_step = 0.025, overbias_wait=2.0, cool_wait=30,make_plot=True, high_current_mode=False, overbias_voltage=15, do_analysis=True)
