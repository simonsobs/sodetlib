...
parser.add_argument('--ctime', type = str)
parser.add_argument('--goodchans',type = bool, default = False)
...
for i in range(2):
    for j in range(2):
        ...
        if i == 0 and j == 1:
            ...
            if cl not in min_goodchans_md['exclude_temps'] and minset:
                method = 'p_sat'
