...
tune_data_smurf = make_map_smurf(tunefile=os.path.join(abs_path_sample_data_default, '1632247315_tune.npy'),
                                 north_is_highband=False)
tune_data_g3 = make_map_g3_timestream(timestream=os.path.join(abs_path_sample_data_default, 'freq_map.npy'),
                                      north_is_highband=False)
