...
stream_time_segone = 60
stream_time_segtwo = 540
# non blocking statement to start time stream and return the dat filename
dat_path = S.stream_data_on()
# collect stream data
time.sleep(stream_time_segone)
#raise BL0 to 12V
S.set_tes_bias_bipolar(11,12)
# keep collect stream data
time.sleep(stream_time_segtwo)
...
for band in sorted(stream_by_band_by_channel.keys()):
    ...
    ax_this_band.set_ylim([-100000, 100000])
