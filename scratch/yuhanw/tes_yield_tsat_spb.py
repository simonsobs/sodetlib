...
for bias_gp in target_BL:
        ...
        iv_data = S.run_iv(bias_groups = [bias_gp], wait_time=0.001, bias_high=bias_high_command, bias_low=bias_low_command, bias_step = bias_step_command, overbias_voltage=20, cool_wait=0, high_current_mode=False, make_plot=False, save_plot=True, cool_voltage = bias_high_command)
